        ...
        <div class="col-lg-4 mx-auto">
          <div class="auth-form-light text-left py-5 px-4 px-sm-5">
            ...
            <form class="pt-3" method="POST" action="{{ route('login.store') }}">
              ...
              <div class="mt-3">
                <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">LOG
                  IN</button>
              </div>
              ...
              <div class="text-center mt-4 fw-light">
                Don't have an account? <a href="/registration" class="text-primary">Register</a>
              </div>
            </form>
          </div>
        </div>
